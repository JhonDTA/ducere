...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create currency' do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { iso_code: @currency.iso_code, name: @currency.name, symbol: @currency.symbol } }
    end
  ...
  test 'should update currency' do
    patch currency_url(@currency), params: { currency: { iso_code: @currency.iso_code, name: @currency.name, symbol: @currency.symbol } }
