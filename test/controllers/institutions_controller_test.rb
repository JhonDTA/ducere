...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create institution' do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { code: @institution.code, description: @institution.description, name: @institution.name, status_id: @institution.status_id } }
    end
  ...
  test 'should update institution' do
    patch institution_url(@institution), params: { institution: { code: @institution.code, description: @institution.description, name: @institution.name, status_id: @institution.status_id } }
