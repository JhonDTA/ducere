...
create_educative_levels if true
create_careers if true
create_syllabuses if true
create_grades if true
create_courses if true
create_cycle_types if true
create_academic_cycles if true
create_modalities if true
create_turns if true
create_evaluation_periods if true
create_relationships if true
create_groups if true
create_level_careers if true
...
create_turn_evaluations if true
create_campus_evaluations if true
